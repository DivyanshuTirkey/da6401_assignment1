...
def sweep():
    ...
    trainer = Trainer(hidden_layers, hidden_size, activation_function, weight_initialization, 'cross_entropy', optimizer, epochs, learning_rate, batch_size, x_train, y_train, x_val, y_val, 10, 0.9, 0.9, 0.9, 0.9, weight_decay, 1e-8, class_names)
...
if __name__ == '__main__':
    ...
    wandb.agent(sweep_id, function=sweep, count=150)
    wandb.teardown()
    wandb.agent(sweep_id,function=test_evaluate, count=1) 